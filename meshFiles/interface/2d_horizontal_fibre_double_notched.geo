...
Point(7)  = {85                 ,   40    ,   0,  	meshSize}; 
Point(8)  = {80                 ,   35    ,   0,  	meshSize}; 
Point(9)  = {75                 ,   40    ,   0,  	meshSize}; 
Point(10) = {0                  ,   40    ,   0,  	meshSize}; 
...
loop1 = newll; Line Loop(loop1) = {l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
...
Point(100)  = {60       		    ,   20    ,   0,  	meshSize}; 
Point(200)  = {100                   ,   20    ,   0,  	meshSize}; 
