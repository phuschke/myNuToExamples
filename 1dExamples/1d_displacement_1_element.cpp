...
//    }
    ...
    myIntegrationScheme.SetTimeStep(1e-0 * simulationTime);
    myIntegrationScheme.SetMinTimeStep(1e-5 * simulationTime);
    myIntegrationScheme.SetMaxTimeStep(1e-0 * simulationTime);
    myIntegrationScheme.SetToleranceForce(1e-8);
    myIntegrationScheme.SetAutomaticTimeStepping(true);
    myIntegrationScheme.SetVerboseLevel(10);
