...
const boost::filesystem::path Parameters::mOutputPath("/home/phuschke/1d_trusses_gmsh/");
const boost::filesystem::path Parameters::mMeshFilePath("/home/phuschke/develop/nuto/myNutoExamples/1d_truss.msh");
...
void run()
{
    ...
    myStructure.LoadCreateNodeForce(0, 1, Parameters::mDirectionX, 1e7);
