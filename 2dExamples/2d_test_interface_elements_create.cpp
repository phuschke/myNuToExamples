...
const boost::filesystem::path Parameters::mMeshFilePath("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/2d_interface_generation.msh");
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        myStructure.InterfaceElementsCreate(fibreElementGroup, interfaceInterpolationType, interfaceMaterial, fibreInterpolationType, fibreMaterial, fibreSection);
