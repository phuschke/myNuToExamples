...
const boost::filesystem::path resultPath("results_single_edge_notched_tension_test/");
const boost::filesystem::path meshFilePath("single_edge_notched_tension_test_quads.msh");

int main(int argc, char* argv[])
{
    if (argc != 3)
    {
        cout << "Input arguments: length scale parameter, artificial viscosity" << endl;
        return EXIT_FAILURE;
    }
