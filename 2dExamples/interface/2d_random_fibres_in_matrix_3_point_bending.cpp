...
const boost::filesystem::path Parameters::mMeshFilePath(
        "/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/interface/2d_horizontal_fibre.msh");
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        int timeDependentConstraint =
                myStructure.ConstraintLinearSetDisplacementNode(nodeLoad, -Parameters::mDirectionY, 1);
