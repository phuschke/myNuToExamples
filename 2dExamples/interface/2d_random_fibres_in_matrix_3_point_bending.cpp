...
public:
    ...
    static constexpr double mFibreYoungsModulus = 2.1e1;   // steel
    ...
    static constexpr double mMaxBondStress = 1e2;
    static constexpr double mResidualBondStress = 1e1;
...
const boost::filesystem::path Parameters::mOutputPath("/home/phuschke/2d_random_fibres_in_matrix_3_point_bending/");
const boost::filesystem::path Parameters::mMeshFilePath("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/interface/2d_horizontal_fibre.msh");
...
//        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterial, NuTo::Constitutive::eConstitutiveParameter::POISSONS_RATIO, Parameters::mMatrixPoissonsRatio);
        ...
        myStructure.InterpolationTypeSetIntegrationType(interfaceInterpolationType, NuTo::IntegrationType::IntegrationType1D2NLobatto4Ip, NuTo::IpData::eIpDataType::STATICDATA);
        ...
        auto elementIds = myStructure.InterfaceElementsCreate(groupIdFibre, interfaceInterpolationType, interfaceMaterial, fibreMatrixBond, fibreInterpolationType, fibreMaterial, fibreSection);
        ...
        myStructure.ConstraintLinearSetDisplacementNode(nodeLeft, Parameters::mDirectionX, 0);
        ...
        nodeCoords[0] = 80.0;
        nodeCoords[1] = 40.0;
        int nodeLoad = myStructure.NodeGetIdAtCoordinate(nodeCoords, 1e-6);

        int timeDependentConstraint = myStructure.ConstraintLinearSetDisplacementNode(nodeLoad, -Parameters::mDirectionY, 1);
