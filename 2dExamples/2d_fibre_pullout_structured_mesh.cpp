...
const boost::filesystem::path Parameters::mMeshFilePath(
        "/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/interface/2d_fiber_structured_mesh.msh");
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        myStructure.InterpolationTypeSetIntegrationType(interfaceInterpolationType,
                                                        NuTo::IntegrationType::IntegrationType1D2NGauss2Ip,
                                                        NuTo::IpData::eIpDataType::STATICDATA);
        ...
        int fibreElement = myStructure.ElementCreate(fibreInterpolationType, fiberNodeIds,
        ...
        int bondElement = myStructure.ElementCreate(interfaceInterpolationType, bondNodeIds,
                                                    NuTo::ElementData::eElementDataType::CONSTITUTIVELAWIP,
                                                    NuTo::IpData::eIpDataType::STATICDATA);
        ...
        myStructure.ConstraintLinearEquationNodeToElementCreate(node01, groupIdMatrix,
                                                                NuTo::Node::eAttributes::DISPLACEMENTS, 0, 5);
        myStructure.ConstraintLinearEquationNodeToElementCreate(node01, groupIdMatrix,
                                                                NuTo::Node::eAttributes::DISPLACEMENTS, 1, 5);

        myStructure.ConstraintLinearEquationNodeToElementCreate(node03, groupIdMatrix,
                                                                NuTo::Node::eAttributes::DISPLACEMENTS, 0, 5);
        myStructure.ConstraintLinearEquationNodeToElementCreate(node03, groupIdMatrix,
                                                                NuTo::Node::eAttributes::DISPLACEMENTS, 1, 5);


        //        myStructure.ConstraintLinearEquationCreate(444,node01,
        //        NuTo::Node::eAttributes::DISPLACEMENTS,0,1.0,0.0);
        //        myStructure.ConstraintLinearEquationAddTerm(444, 20, NuTo::Node::eAttributes::DISPLACEMENTS, 0, -1.0);
        //
        //        myStructure.ConstraintLinearEquationCreate(555,node01,
        //        NuTo::Node::eAttributes::DISPLACEMENTS,1,1.0,0.0);
        //        myStructure.ConstraintLinearEquationAddTerm(555, 20, NuTo::Node::eAttributes::DISPLACEMENTS, 1, -1.0);
        //
        //
        //        myStructure.ConstraintLinearEquationCreate(666,node03,
        //        NuTo::Node::eAttributes::DISPLACEMENTS,0,1.0,0.0);
        //        myStructure.ConstraintLinearEquationAddTerm(666, 21, NuTo::Node::eAttributes::DISPLACEMENTS, 0, -1.0);
        //
        //        myStructure.ConstraintLinearEquationCreate(777,node03,
        //        NuTo::Node::eAttributes::DISPLACEMENTS,1,1.0,0.0);
