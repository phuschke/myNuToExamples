...
public:
    ...
    static constexpr double mTimeStep = 1.e-1;
    static constexpr double mMinTimeStep = 1.e-1;
    static constexpr double mMaxTimeStep = 1.e-1;
...
const boost::filesystem::path Parameters::mOutputPath("/home/phuschke/2d_interface_goodman_pullout/");
