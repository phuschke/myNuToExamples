...
int main(int argc, char* argv[])
{
    try
    {
        ...
        int matrixElement = myStructure.ElementCreate(matrixInterpolationType, matrixNodeIds,
        ...
        myStructure.ConstraintLinearEquationNodeToElementCreate(node04, matrixElement,
                                                                NuTo::Node::eAttributes::DISPLACEMENTS, 0);
        myStructure.ConstraintLinearEquationNodeToElementCreate(node06, matrixElement,
                                                                NuTo::Node::eAttributes::DISPLACEMENTS, 0);
        ...
        int timeDependentConstraint =
                myStructure.ConstraintLinearSetDisplacementNode(node01, Parameters::mDirectionX, 1);
