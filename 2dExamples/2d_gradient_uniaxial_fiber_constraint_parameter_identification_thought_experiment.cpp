...
int main(int argc, char* argv[])
{
    ...
    char tmpChar[200];
    sprintf(tmpChar, "/home/phuschke/2d_parameter_identification/2d_gradient_uniaxial_thought_experiment_fractureEnergy_%f_nonlocal_radius_%f_maxBondStress_%f_mSlipAtMaxBondStress_%f/", matrixFractureEnergy,matrixNonlocalRadius,maxBondStress,mSlipAtMaxBondStress);
    ...
    try
    {
        ...
        int matrixMaterial_elastic = myStructure.ConstitutiveLawCreate(NuTo::Constitutive::eConstitutiveType::LINEAR_ELASTIC_ENGINEERING_STRESS);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterial_elastic, NuTo::Constitutive::eConstitutiveParameter::YOUNGS_MODULUS, matrixYoungsModulus);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterial_elastic, NuTo::Constitutive::eConstitutiveParameter::POISSONS_RATIO, matrixPoissonsRatio);
        ...
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterial, NuTo::Constitutive::eConstitutiveParameter::NONLOCAL_RADIUS_PARAMETER, 2);
        ...
        int matrixInterpolationType_elastic = myStructure.InterpolationTypeCreate(NuTo::Interpolation::eShapeType::TRIANGLE2D);
        myStructure.InterpolationTypeAdd(matrixInterpolationType_elastic, NuTo::Node::COORDINATES, NuTo::Interpolation::EQUIDISTANT1);
        myStructure.InterpolationTypeAdd(matrixInterpolationType_elastic, NuTo::Node::DISPLACEMENTS, NuTo::Interpolation::EQUIDISTANT2);

        int matrixInterpolationType_damage = myStructure.InterpolationTypeCreate(NuTo::Interpolation::eShapeType::TRIANGLE2D);
        myStructure.InterpolationTypeAdd(matrixInterpolationType_damage, NuTo::Node::COORDINATES, NuTo::Interpolation::EQUIDISTANT1);
        myStructure.InterpolationTypeAdd(matrixInterpolationType_damage, NuTo::Node::DISPLACEMENTS, NuTo::Interpolation::EQUIDISTANT2);
        myStructure.InterpolationTypeAdd(matrixInterpolationType_damage, NuTo::Node::NONLOCALEQSTRAIN, NuTo::Interpolation::EQUIDISTANT1);
        ...
        myStructure.InterpolationTypeSetIntegrationType(matrixInterpolationType_damage, NuTo::IntegrationType::IntegrationType2D3NGauss3Ip, NuTo::IpData::eIpDataType::STATICDATA);
...
//        myStructure.GroupAddNodeCoordinateRange(groupNodePredamaged, 0, matrixLengthX/2 - 1 - 1e-6, matrixLengthX/2 + 1 + 1e-6);
//
...
//                {
//                    elePtr->GetStaticData(iIp)->AsGradientDamage()->SetKappa(2 * matrixTensileStrength / matrixYoungsModulus);
//                }
//            }
//        }
...
//
        ...
        {
            myStructure.ConstraintLinearEquationNodeToElementCreate(nodeIds.at(iNode, 0), groupIdMatrix, NuTo::Node::eDof::DISPLACEMENTS, numNearestNeighbours);
        }
        ...
        auto pairGroupFiberGroupBond = myStructure.InterfaceElementsCreate(groupIdFiber, interfaceInterpolationType, fibreInterpolationType);
