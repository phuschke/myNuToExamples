...
int main(int argc, char* argv[])
{
    ...
    char tmpChar[200];
    sprintf(tmpChar, "/home/phuschke/2d_fibre_pullout_gmsh_gradient_damage/2d_gradient_uniaxial_thought_experiment_fractureEnergy_%f_fibreCrossSection_%f_maxBondStress_%f_mSlipAtMaxBondStress_%f/", matrixFractureEnergy,fibreCrossSection,maxBondStress,mSlipAtMaxBondStress);
    const std::string resultDir = tmpChar;

    const std::string meshFileMatrix("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/2d/2d_fibre_pullout_matrix_constraints_matrix.msh");
    const std::string meshFileFibre("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/2d/2d_fibre_pullout_matrix_constraints_fiber.msh");
