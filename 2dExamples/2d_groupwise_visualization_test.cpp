...
const boost::filesystem::path Parameters::mOutputPath("/home/phuschke/2d_groupwise_visualization_test_new_99/");
const boost::filesystem::path Parameters::mMeshFilePathMatrix("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/2d_uniaxial_tension.msh");
...
//        myStructure.InterpolationTypeAdd(matrixInterpolationType, NuTo::Node::NONLOCALEQSTRAIN, NuTo::Interpolation::EQUIDISTANT1);         // Gradient damage model
        ...
        myStructure.GroupAddNodeCoordinateRange(groupNodeBCRight, 0, 300.0 - 1.0e-6, 300.0 + 1.0e-6);
        ...
        int  groupTest = myStructure.GroupCreate(NuTo::Groups::Elements);
        myStructure.GroupAddElement(groupTest, 109);
        myStructure.GroupAddElement(groupTest, 110);

        myStructure.AddVisualizationComponent(groupTest, NuTo::VisualizeBase::ENGINEERING_STRAIN);
        myStructure.SetVisualizationType(groupTest, NuTo::VisualizeBase::POINTS);
        ...
        std::cout << "Group Id: " << groupTest << std::endl;
        std::cout << "***********************************" << std::endl;
