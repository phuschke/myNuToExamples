...
const boost::filesystem::path Parameters::mMeshFilePathMatrix("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/3d/3d_fibre_pullout_matrix.msh");
...
int main(int argc, char* argv[])
{
    try
    {
        ...
        int fibreElementID = myStructure.ElementCreate(fibreInterpolationType, nodeIndicesFibre, NuTo::ElementData::eElementDataType::CONSTITUTIVELAWIP, NuTo::IpData::eIpDataType::NOIPDATA);
        ...
        int interfaceElementID = myStructure.ElementCreate(interfaceInterpolationType, nodeIndicesInterface, NuTo::ElementData::eElementDataType::CONSTITUTIVELAWIP, NuTo::IpData::eIpDataType::STATICDATA);
...
//        int timeDependentConstraint = myStructure.ConstraintLinearSetDisplacementNodeGroup(groupNodeBCRight, Parameters::mDirectionX, 1);
        ...
        int timeDependentConstraint = myStructure.ConstraintLinearSetDisplacementNode(node02, Parameters::mDirectionX, 1);
