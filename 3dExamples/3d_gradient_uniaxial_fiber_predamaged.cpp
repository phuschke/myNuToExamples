...
//    const double fiberVolume = 0.4082;
    ...
    char tmpChar[200];
    sprintf(tmpChar, "/home/phuschke/3d_parameter_identification/3d_gradient_predamaged_fractureEnergy_%f_nonlocalRadius_%f_maxBondStress_%f_mSlipAtMaxBondStress_%f_0_fiber/", matrixFractureEnergy, matrixNonlocalRadius, maxBondStress, mSlipAtMaxBondStress);
...
//            myStructure.Restore("/home/phuschke/serialization_files/StructureOut", "BINARY");
        ...
        } else
        {
            ...
            myStructure.GroupAddNodeCoordinateRange(groupNodePredamaged, 0, matrixLengthX/2 - 2 - 1e-6, matrixLengthX/2 + 2 + 1e-6);
...
//        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterial, NuTo::Constitutive::eConstitutiveParameter::POISSONS_RATIO, matrixPoissonsRatio);
        ...
        int matrixMaterialWeak = myStructure.ConstitutiveLawCreate(NuTo::Constitutive::eConstitutiveType::GRADIENT_DAMAGE_ENGINEERING_STRESS);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterialWeak, NuTo::Constitutive::eConstitutiveParameter::YOUNGS_MODULUS, 0.9*matrixYoungsModulus);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterialWeak, NuTo::Constitutive::eConstitutiveParameter::POISSONS_RATIO, matrixPoissonsRatio);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterialWeak, NuTo::Constitutive::eConstitutiveParameter::NONLOCAL_RADIUS, matrixNonlocalRadius);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterialWeak, NuTo::Constitutive::eConstitutiveParameter::TENSILE_STRENGTH, matrixTensileStrength);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterialWeak, NuTo::Constitutive::eConstitutiveParameter::COMPRESSIVE_STRENGTH, matrixCompressiveStrength);
        myStructure.ConstitutiveLawSetParameterDouble(matrixMaterialWeak, NuTo::Constitutive::eConstitutiveParameter::FRACTURE_ENERGY, matrixFractureEnergy);
...
//        myStructure.ElementGroupSetConstitutiveLaw(groupEleBond,    interfaceMaterial);
        ...
        myStructure.GroupAddNodeCoordinateRange(groupNodeBCRight, 0, matrixLengthX - 5 - 1e-6, matrixLengthX - 5 + 1e-6);
