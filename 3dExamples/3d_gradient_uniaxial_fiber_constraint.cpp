...
const std::string Parameters::mMeshFilePathMatrix("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/3d/3d_uniaxial_matrix_ehlers.msh");
const std::string Parameters::mMeshFilePathFibre("/home/phuschke/develop/nuto/myNutoExamples/MeshFiles/3d/trusses200Dogbone.msh");
...
//
        ...
        myStructure.GroupAddNodeCoordinateRange(groupNodeBCRight, 0, Parameters::mMatrixLengthX - 1e-6, Parameters::mMatrixLengthX + 1e-6);
